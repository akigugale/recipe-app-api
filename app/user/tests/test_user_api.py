...
# Naming convention is capital for constants
...
class PublicUserApiTests(TestCase):
    ...
    # Cresting a client to use in all tests
    def setUp(self):
    ...
    def test_create_valid_user_sucess(self):
        ...
        # ** unwinds the data into seperate list / dict
...
class PrivateUserApiTests(TestCase):
    ...
    def test_update_user_profile(self):
        """test that a profile is updated for authenticated user"""
